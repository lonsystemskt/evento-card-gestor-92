...
const EventRow: React.FC<EventRowProps> = ({
  ...
  const scroll = (direction: 'left' | 'right') => {
    ...
    const scrollAmount = 250; // Aproximadamente 1 card + espaço
  ...
  const canScrollRight = demands.length > 3; // Aproximadamente 3 cards visíveis
        ...
        <div className="flex items-center space-x-3 min-w-0 flex-shrink-0">
          ...
          <div className="relative flex-shrink-0">
            <button
              ...
              className="glass-button p-2 rounded-lg hover:bg-white/20 transition-all"
            >
              <MoreVertical size={16} className="text-blue-300" />
            </button>
